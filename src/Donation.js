...
class Donation extends Component {
  ...
  render() {
    return (
     ...
     <img src="https://www.kokilabenhospital.com/blog/wp-content/uploads/2020/06/Blood-compatibility.jpg" id="donto"></img>
...
//         <input type="submit" id="submit" onClick={alert("The form was submitted")}></input>
//         </form>
//     </div>
//     </body>
//     </>
